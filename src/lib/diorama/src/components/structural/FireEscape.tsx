  ...
  useEffect(() => {
    ...
    for (let floor = 0; floor < floors; floor++) {
      ...
      for (const beamZ of [-platformDepth / 2 + 0.1, platformDepth / 2 - 0.1]) {
        ...
        beam.position = new Vector3(posX + zigzagOffset, platformY - 0.045, posZ + beamZ);
      ...
      if (floor < floors - 1) {
        ...
        const _stairStartX =
          style === 'zigzag' ? (floor % 2 === 0 ? platformWidth / 2 : platformWidth / 2) : 0;
    ...
    if (hasDropLadder) {
      ...
      for (let i = 0; i < rungCount; i++) {
        ...
        rung.position = new Vector3(posX, rungY, posZ + platformDepth / 2 - 0.2);
      ...
      bracket.position = new Vector3(posX, posY - 0.1, posZ + platformDepth / 2 - 0.15);
      bracket.material = frameMat;
      meshes.push(bracket);
    }
