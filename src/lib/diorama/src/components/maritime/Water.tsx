...
import { type AbstractMesh, Color3, MeshBuilder, PBRMaterial, type Vector3 } from '@babylonjs/core';
...
export function Water({
  ...
  }, [scene, id, position, size, depth, color, opacity, reflectivity, animated, onReady]);
