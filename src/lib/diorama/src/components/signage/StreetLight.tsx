...
export function StreetLight({
  ...
  useEffect(() => {
    ...
    if (style === 'modern') {
      ...
      // Arm
      const arm = MeshBuilder.CreateCylinder(`${id}_arm`, { height: 1.2, diameter: 0.06 }, scene);
      ...
      const glass = MeshBuilder.CreateSphere(`${id}_glass`, { diameter: 0.2 }, scene);
      ...
      // Neon tube
      const tube = MeshBuilder.CreateCylinder(`${id}_tube`, { height: 1.5, diameter: 0.04 }, scene);
      ...
      // Arm
      const arm = MeshBuilder.CreateCylinder(`${id}_arm`, { height: 0.6, diameter: 0.04 }, scene);
      ...
      lanternMat.albedoColor = isOn ? new Color3(1, 0.9, 0.7) : new Color3(0.9, 0.85, 0.75);
