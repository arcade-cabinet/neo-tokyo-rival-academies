...
export class CombatSystem {
   ...
   */
  calculateDamage(attacker: Combatant, defender: Combatant, isCritical: boolean): number {
   ...
   */
  executeAction(attacker: Combatant, defender: Combatant, action: CombatAction): CombatResult {
   ...
   */
  createEnemyFromTemplate(template: EnemyTemplate, index: number = 0): Combatant {
    return {
