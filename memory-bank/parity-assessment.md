...
- **Missing categories**: remaining signage + structural variants and detailed prop geometry (furniture/props now have initial kit ports).
...
- **Furniture/Props kits**: `FurnitureKit`, `PropKit` with seeded placement in FloodedWorldBuilder.
