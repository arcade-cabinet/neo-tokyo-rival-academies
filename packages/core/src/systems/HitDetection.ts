 ...
 */
export function isInvincible(invincibility: InvincibilityState | undefined): boolean {
 ...
 */
export function getInvincibilityProgress(invincibility: InvincibilityState | undefined): number {
  if (!invincibility || !invincibility.active || invincibility.duration === 0) return 0;
 ...
 */
export function checkAABBCollision(pos1: Vec3, size1: Vec3, pos2: Vec3, size2: Vec3): boolean {
  const halfSize1 = { x: size1.x / 2, y: size1.y / 2, z: size1.z / 2 };
  const halfSize2 = { x: size2.x / 2, y: size2.y / 2, z: size2.z / 2 };

  const min1 = { x: pos1.x - halfSize1.x, y: pos1.y - halfSize1.y, z: pos1.z - halfSize1.z };
  const max1 = { x: pos1.x + halfSize1.x, y: pos1.y + halfSize1.y, z: pos1.z + halfSize1.z };

  const min2 = { x: pos2.x - halfSize2.x, y: pos2.y - halfSize2.y, z: pos2.z - halfSize2.z };
  const max2 = { x: pos2.x + halfSize2.x, y: pos2.y + halfSize2.y, z: pos2.z + halfSize2.z };
