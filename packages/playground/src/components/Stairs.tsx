...
const MATERIAL_COLORS: Record<StairMaterial, { base: Color3; metallic: number; roughness: number }> = {
...
export function Stairs({
	...
	}, [scene, id, posX, posY, posZ, height, width, type, material, rotation, stepCount, handrails, seed]);
