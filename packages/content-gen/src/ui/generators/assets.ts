...
export async function generateAssets() {
  ...
  await saveSVG(
    'dpad-up',
    createSVG(100, 100, `<path d="${arrowPath}" fill="#0ff" stroke="#008888" stroke-width="5" />`)
  );
  await saveSVG(
    'dpad-down',
    createSVG(
      100,
      100,
      `<path d="${arrowPath}" fill="#0ff" stroke="#008888" stroke-width="5" transform="rotate(180 50 50)" />`
    )
  );
  await saveSVG(
    'dpad-left',
    createSVG(
      100,
      100,
      `<path d="${arrowPath}" fill="#0ff" stroke="#008888" stroke-width="5" transform="rotate(-90 50 50)" />`
    )
  );
  await saveSVG(
    'dpad-right',
