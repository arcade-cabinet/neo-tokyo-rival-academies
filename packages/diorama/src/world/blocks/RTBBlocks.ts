...
import { type BlockDefinition, GRID_UNIT_SIZE, registerBlock, type SnapPoint } from './Block';

// ============================================================================
// HELPER: Create standard edge snap points for a block
// ============================================================================

function createEdgeSnapPoints(width: number, depth: number, height: number = 0): SnapPoint[] {
  const halfW = width / 2;
  const halfD = depth / 2;
...
export const RTB_MARKET_STALLS: BlockDefinition = {
  ...
  snapPoints: [...createEdgeSnapPoints(GRID_UNIT_SIZE * 2, GRID_UNIT_SIZE)],
