...
import type { BlockDefinition, BlockInstance, SnapDirection, SnapPoint } from './Block';
...
export function SnapPointVisualizer({
  ...
  useEffect(() => {
    ...
    arrow.position = worldPos.add(new Vector3(rotatedDirX, dirOffset.y, rotatedDirZ));
 ...
 */
export function BlockInstanceRenderer({ instance, debugMode = true }: BlockInstanceRendererProps) {
