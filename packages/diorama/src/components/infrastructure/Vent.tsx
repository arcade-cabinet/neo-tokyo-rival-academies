	...
	useEffect(() => {
		...
		if (type === "turbine") {
			...
			housing.position = new Vector3(
				posX,
				posY + baseHeight + turbineHeight * 0.3,
				posZ,
			);
			...
			cap.position = new Vector3(
				posX,
				posY + baseHeight + turbineHeight * 0.75,
				posZ,
			);
			...
			cap.position = new Vector3(
				posX,
				posY + stemHeight + capHeight / 2 + 0.05,
				posZ,
			);
			cap.material = metalMat;
			meshes.push(cap);
			...
			gapRing.position = new Vector3(
				posX,
				posY + stemHeight + airGap / 2,
				posZ,
			);
