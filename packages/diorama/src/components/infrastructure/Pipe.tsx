...
export function Pipe({
	...
	useEffect(() => {
		...
		if (valve) {
			...
			wheel.position = valvePos.add(
				perpendicular.scale(diameter + handleRadius),
			);
			...
			stem.position = valvePos.add(
				perpendicular.scale((diameter + handleRadius) / 2),
			);
