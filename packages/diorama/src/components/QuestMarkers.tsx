...
export function QuestMarkers({ markers, onMarkerInteract, floatHeight = 2.5 }: QuestMarkersProps) {
  ...
  useEffect(() => {
    ...
    for (const marker of markers) {
      ...
      if (!mesh) {
        ...
        mesh = createMarkerMesh(scene, marker, floatHeight, glowLayerRef.current);
