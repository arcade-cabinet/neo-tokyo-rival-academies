	...
	useEffect(() => {
		...
		if (type === "american") {
			...
			const base = MeshBuilder.CreateCylinder(
				...
				{
					height: 0.08,
					diameterTop: bodyRadius * 2.2,
					diameterBottom: bodyRadius * 2.5,
				},
				scene,
			);
			...
			const bonnet = MeshBuilder.CreateCylinder(
				...
				{
					height: height * 0.25,
					diameterTop: bodyRadius * 1.2,
					diameterBottom: bodyRadius * 2,
				},
				scene,
			);
			bonnet.position = new Vector3(
				posX,
				posY + 0.08 + height * 0.6 + (height * 0.25) / 2,
				posZ,
			);
			...
			const base = MeshBuilder.CreateCylinder(
				...
				{
					height: 0.05,
					diameterTop: bodyRadius * 2.5,
					diameterBottom: bodyRadius * 2.8,
				},
				scene,
			);
			...
			lowerBody.position = new Vector3(
				posX,
				posY + 0.05 + (height * 0.4) / 2,
				posZ,
			);
			...
			const upperBody = MeshBuilder.CreateCylinder(
				...
				{
					height: height * 0.35,
					diameterTop: bodyRadius * 1.6,
					diameterBottom: bodyRadius * 2,
				},
				scene,
			);
			upperBody.position = new Vector3(
				posX,
				posY + 0.05 + height * 0.4 + (height * 0.35) / 2,
				posZ,
			);
			...
			top.position = new Vector3(
				posX,
				posY + 0.08 + height * 0.7 + (height * 0.2) / 2,
				posZ,
			);
