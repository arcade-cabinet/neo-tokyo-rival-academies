...
export type TrafficSignType =
	...
	| "parking"
	| "noEntry";
export type TrafficSignCondition =
	| "new"
	| "weathered"
	| "damaged"
	| "vandalized";
	...
	useEffect(() => {
		...
		switch (type) {
			...
			case "oneway":
				...
				break;
			case "speed":
				signMat.albedoColor = new Color3(0.95, 0.95, 0.95).scale(
					conditionFactor,
				);
				break;
			case "warning":
				signMat.albedoColor = new Color3(0.95, 0.85, 0.1).scale(
					conditionFactor,
				);
				break;
			case "street":
				signMat.albedoColor = new Color3(0.15, 0.45, 0.15).scale(
					conditionFactor,
				);
				break;
			case "parking":
				signMat.albedoColor = new Color3(0.15, 0.35, 0.7).scale(
					conditionFactor,
				);
				break;
			case "noEntry":
		...
		switch (type) {
			...
			case "yield": {
				...
				signMesh = MeshBuilder.CreateDisc(
					`${id}_sign`,
					{ radius: 0.35, tessellation: 3 },
					scene,
				);
