...
VERIFICATION_DIR = os.environ.get("VERIFICATION_DIR", "/home/jules/verification")
...
def verify_rpg_gameplay(page: Page):
    ...
    page.screenshot(path=os.path.join(VERIFICATION_DIR, "1_menu.png"))
    ...
    time.sleep(2)
    page.screenshot(path=os.path.join(VERIFICATION_DIR, "2_dialogue_intro.png"))
    ...
    time.sleep(3)
    page.screenshot(path=os.path.join(VERIFICATION_DIR, "3_gameplay_hud.png"))
