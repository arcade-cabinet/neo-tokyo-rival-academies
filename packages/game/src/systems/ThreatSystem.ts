...
export class ThreatSystem {
   ...
   */
  updateThreat(id: string, position: Vector3, threatLevel: number, currentTime: number): void {
   ...
   */
  getPriorityTarget(fromPosition: Vector3, currentTime: number): ThreatTarget | null {
