...
import type { DataShard, QuestMarker } from '@neo-tokyo/diorama';
import {
  BackgroundPanels,
  Character,
...
function SceneContent({
  ...
  children?: ReactNode;
  inputState?: BabylonDioramaSceneProps['inputState'];
}) {
  ...
  const [animationController, setAnimationController] =
    useState<CharacterAnimationController | null>(null);
  ...
  return (
    <>
      ...
      {/* Quest markers */}
      <QuestMarkers markers={questMarkers} onMarkerInteract={handleMarkerInteract} />

      {/* Data shards */}
      <DataShards shards={dataShards} onCollect={handleShardCollect} />
