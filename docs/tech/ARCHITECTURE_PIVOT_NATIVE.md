...
- **UI**: Ionic + Angular
- **3D**: Babylon.js (WebGL)
- **Logic**: Shared ECS packages (`packages/core`)

## 3. Current Repo Layout

```
root/
├── src/              # Ionic Angular unified app
...
## 4. Migration Steps
1. **Port** React/Reactylon UI and Babylon scene to Angular + Babylon imperative.
2. **Wire** ECS packages into the app.
3. **Remove/Archive** legacy React/Expo apps.
4. **Add** optional Electron target using same web bundle.
