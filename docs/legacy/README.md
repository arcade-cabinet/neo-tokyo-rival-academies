...
- Treat legacy docs as **context only**.
- If a legacy idea is still valuable, migrate it into the appropriate `/docs/*` domain and note the move in `/docs/00-golden/DEPRECATIONS.md`.
